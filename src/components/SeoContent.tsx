      ...
      <section className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-2 pt-4 border-t border-border">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            ...
            <a href="https://www.avito.ru/brands/i141094380" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-sm text-primary hover:underline">
              <svg className="w-4 h-4" viewBox="0 0 256 256" fill="currentColor"><path d="M208 28H48A20 20 0 0 0 28 48v160a20 20 0 0 0 20 20h160a20 20 0 0 0 20-20V48a20 20 0 0 0-20-20zm-4 176H52V52h152zM76 100a24 24 0 1 1 24 24 24 24 0 0 1-24-24zm28 0a4 4 0 1 0-4 4 4 4 0 0 0 4-4zm76-24a24 24 0 1 1-24 24 24 24 0 0 1 24-24zm0 40a16 16 0 1 0-16-16 16 16 0 0 0 16 16zm-52 20a24 24 0 1 1-24 24 24 24 0 0 1 24-24zm0 40a16 16 0 1 0-16-16 16 16 0 0 0 16 16z"/></svg>
              Авито
            </a>
          </div>
