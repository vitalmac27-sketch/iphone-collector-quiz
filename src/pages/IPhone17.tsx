...
const IPhone17Page = () => {
  ...
  const reviews = [
    ...
    { name: "Регина", text: "Долго выбирала между 16 и 17 — взяла 17-й и не жалею! Чип A19 заметно быстрее, приложения летают.", rating: 5, date: "Февраль 2026" },
    { name: "Айдар", text: "Заказал доставку на Ямашева — привезли за 40 минут. Телефон новый, запечатанный. Цена реально лучшая в Казани.", rating: 5, date: "Январь 2026" },
    { name: "Светлана", text: "Покупала маме на Новый год. Всё объяснили, помогли с настройкой. Мама в восторге от качества фото!", rating: 5, date: "Декабрь 2025" },
    { name: "Булат", text: "Третий айфон беру в ЭПЛ-КОЛЛЕКЦИЯ. Всегда честные цены и реальная гарантия. iPhone 17 — отличный аппарат.", rating: 5, date: "Ноябрь 2025" },
    { name: "Диана", text: "Оформила рассрочку за 5 минут прямо при курьере. Никаких скрытых платежей, всё прозрачно. Рекомендую!", rating: 5, date: "Ноябрь 2025" },
    { name: "Рафаэль", text: "Dynamic Island — это очень удобно для навигации и музыки. iPhone 17 стоит каждого рубля. Доставка в Авиастроительный бесплатная.", rating: 5, date: "Октябрь 2025" },
    { name: "Карина", text: "Сдала iPhone 14 по Trade-in — получила скидку 30%! iPhone 17 намного быстрее и камера лучше. Спасибо за сервис!", rating: 5, date: "Октябрь 2025" },
  ];
