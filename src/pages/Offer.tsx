        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
            <section>
              ...
              <p>Настоящий документ является официальным предложением (публичной офертой) <p>Настоящий документ является официальным предложением (публичной офертой) ИП Дарьин М.П. (далее — Продавец) в адрес любого физического лица (далее — Покупатель) заключить договор купли-продажи товаров на условиях, изложенных ниже.</p> в адрес любого физического лица (далее — Покупатель) заключить договор купли-продажи товаров на условиях, изложенных ниже.</p>
            ...
            <section>
              ...
              <ul className="list-none space-y-1 pl-0">
                <li>Индивидуальный предприниматель <strong className="text-foreground">Дарьин М.П.</strong></li>
